...
const toggleVariants = cva(
  'inline-flex items-center justify-center gap-1.5 rounded-[8px] text-[12px] font-medium outline-none press focus-visible:ring-2 focus-visible:ring-[var(--accent)]/40 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
      ...
      size: {
        default: 'h-8 min-w-8 px-2 coarse:h-9 coarse:min-w-9',
        sm: 'h-7 min-w-7 px-1.5 text-[11px] coarse:h-8 coarse:min-w-8',
        lg: 'h-9 min-w-9 px-2.5 coarse:h-10 coarse:min-w-10',
      },
    },
