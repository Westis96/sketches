...
autosave in the browser (localStorage) and are restored on the next visit; Clear resets
the drawing and its history (Undo right after brings it back, until the next stroke),
